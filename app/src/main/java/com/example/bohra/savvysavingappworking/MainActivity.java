...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText purchaseAmountEditText = (EditText) findViewById(R.id.PurchaseAmounteditText);
        EditText purchaseCommentEditText = (EditText) findViewById(R.id.PurchaseCommentText2);
        Spinner purchaseScategorySpinner = (Spinner) findViewById(R.id.newPurchaseCategory);
        ProgressBar dailyBreakdown = (ProgressBar) findViewById(R.id.progressBar) ;
